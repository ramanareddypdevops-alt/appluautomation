...
safe_mode = True                    # True or False, Note: Uses a dedicated bot profile to avoid normal Chrome profile locks.
manual_login_only = True            # True or False, Note: False lets the bot fill in `username`/`password` from secrets.py automatically.
...
stealth_mode = False                 # True or False, Note: Use the stealth driver for LinkedIn compatibility.
...
MAX_APPLICATIONS_PER_SESSION = 40
