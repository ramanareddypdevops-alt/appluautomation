...
def validate_questions() -> None | ValueError | TypeError:
    ...
    check_string(citizenship, "citizenship", ["Yes", "No", "U.S. Citizen/Permanent Resident", "Non-citizen allowed to work for any employer", "Non-citizen allowed to work for current employer", "Non-citizen seeking work authorization", "Canadian Citizen/Permanent Resident", "Other"])
...
def validate_search() -> None | ValueError | TypeError:
    ...
    check_list(allowed_job_location_terms, "allowed_job_location_terms", min_length=1)
    ...
    check_boolean(sponsorship_required, "sponsorship_required")
    check_list(sponsorship_terms, "sponsorship_terms", min_length=1)
...
def validate_settings() -> None | ValueError | TypeError:
    ...
    check_boolean(manual_login_only, "manual_login_only")
